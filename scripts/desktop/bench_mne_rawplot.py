...
Placeholder benchmark entrypoint for MNE Raw.plot.
...
from benchkit.lexicon import BENCH_A1, BENCH_A2, BENCH_TFFR, FMT_EDF, FMT_NWB, TOOL_MNE_RAWPLOT


def main() -> None:
    ap = argparse.ArgumentParser(description="MNE Raw.plot benchmark (placeholder).")
    ...
    write_json(out / "summary.json", {"bench_id": args.bench_id, "tool_id": TOOL_MNE_RAWPLOT, "status": "not_implemented"})
